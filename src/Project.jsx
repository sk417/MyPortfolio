                    ...
                    <h2 className="title" data-aos="fade-down">Projects</h2>
                        <div className="content">
                            ...
                            <h1>Weather App</h1>
                                ...
                                <div className="text">
                                    <a href="http://weather-app-sudheer.herokuapp.com/" target='blank'>Demo</a>
                                    <a href="https://github.com/sk417/weather-app" target='blank'>Github repo.</a>
                                </div>
                            </div>
                            <div className="card" data-aos="fade-down">
                            <h1>Coding Learning App</h1>
                                ...
                                <div className="text">
                                    <a href="https://allinonecoding.herokuapp.com/" target='blank'>Demo</a>
                                    <a href="https://github.com/sk417/coding-learning-websit" target='blank'>Github repo.</a>
                                </div>
                            </div>
                            <div className="card" data-aos="fade-down">
                            <h1>Chat App</h1>
